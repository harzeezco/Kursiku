...
function Features() {
  const background = "#103C44 url('/png/home/bg.png') no-repeat center center";
  ...
  return (
    ...
    >
      <div className='container relative flex flex-col items-center justify-between gap-8 p-20 md:flex-row'>
        <div>
          ...
          <ul className='mt-20 grid gap-7 text-white'>
